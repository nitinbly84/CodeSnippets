...
public class Executor {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n-------Searching the kids of Sanchita Das-----------");
		Member memberNoKid = new Member("Sanchita Das"); //Parent & kid of Sunil
		memberNoKid.setAge(58);
		memberNoKid.setAlive(true);
		Member parent = amphora.getMember(memberNoKid).orElse(null);
		List<Member> children = amphora.getMemberOfRelation(parent, RelationType.KIDS);
		if(children.isEmpty())
